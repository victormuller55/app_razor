...
import 'package:app_razor/pages/cadastro/cadastro_page.dart';
import 'package:app_razor/pages/login/login_bloc.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  void _openCadastro() {
    open(screen: const CadastroPage(), closePrevious: true);
  }

  void _openRecuperacaoSenha() {
    showSnackbarWarning(
      message: 'Recuperação de senha ainda não está disponível',
    );
  }
  ...
  Widget _actionsBotoes() {
    return Column(
      children: [
        ...
        appTextButton(
          text: AppStrings.esqueciMinhaSenha,
          onTap: _openRecuperacaoSenha,
          color: local.AppColors.textSecondary,
        ),
      ],
    );
